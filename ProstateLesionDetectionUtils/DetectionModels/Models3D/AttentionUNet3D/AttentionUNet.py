...
class TrainAttentionUnet:
    ...
    def ModelBuild(self):
        ...
        self.model = AttentionUnetMod(num_filters = self.params["FILTERS"], pool_size = self.params["POOL_SIZE"], kernel_size = self.params["kernel_size"])
