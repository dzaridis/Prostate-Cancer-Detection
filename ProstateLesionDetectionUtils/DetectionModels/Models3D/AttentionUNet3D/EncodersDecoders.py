...
class EncoderBlock(tf.keras.Model):
    ...
    def __init__(self, filters, pool_size, **kwargs):
        ...
        self.convnet = LayerUtils3D.ConvModule3D(filters, kernel_size = self.kernel_size)
...
class DecoderBlock(tf.keras.Model):
    ...
    def __init__(self, filters, up_size, **kwargs):
        ...
        self.conv2 = LayerUtils3D.ConvModule3D(filters, kernel_size = self.kernel_size)
        self.attention_gate = LayerUtils3D.AttentionGate3D(filters,up_size)
